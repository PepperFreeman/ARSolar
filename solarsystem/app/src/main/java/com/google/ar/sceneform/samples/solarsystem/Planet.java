...
public class Planet extends Node implements Node.OnTapListener {
 ...
 // private ArSceneView arSceneView;
  ...
  public void onTap(HitTestResult hitTestResult, MotionEvent motionEvent) {
    ...
    if (this.SecondTap){
      this.setLocalPosition(this.previousPostion);
      return;
    }
    //this.arSceneView.pause();
    //this.previousPostion = this.getLocalPosition();
    //Pose pose = arSceneView.getArFrame().getCamera().getPose();
    //this.setLocalPosition(new Vector3(pose.getTranslation()[0], pose.getTranslation()[1], pose.getTranslation()[2]));
